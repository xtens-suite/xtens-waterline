...
class WtKnexCrudStrategy extends WtCrudStrategy {
     ...
     */
     createDataType(dataType) {
         ...
         return global.sails.model.datatype.create({
                 name: dataType.name,
    ...
    updateDataType(dataType) {
      ...
      return global.sails.model.datatype.update({id : dataType.id },{
          name: dataType.name,
          model: dataType.model,
          schema: dataType.schema,
          parents: dataType.parents,
    ...
    deleteDataType(id) {
        ...
        return global.sails.model.datatype.destroy({id : id })
        .then(function(res) {
            return res;
        })
        .catch(function(error) {
    ...
    getDataTypesByRolePrivileges(criteria) {
        ...
        //
         ...
         if (criteria.parentDataType) {
          //  return global.sails.model.datatype.find({id:idDataTypes});
        ...
        .then(function(results) {
            if (results.length) {   // if there are files store their URIs on the database
                ...
                return _.each(files, function(file) {
                  global.sails.model.datafile.create({
                    uri: file.uri,
        ...
        .then(function(idFiles) {
            ...
            if (tableName == 'data'){
              return BluebirdPromise.map(idFiles, function(idFile) {
                  ...
                  return global.sails.model.data.findOne({id: idData}).populate('files')
                  ...
                  return global.sails.model.sample.findOne({id: idData}).populate('files')
                    .then(function(err,res){
    ...
    createData(data, dataTypeName) {
        ...
        return global.sails.model.data.create({
                type: data.type,
    ...
    updateData(data) {
        ...
        // transaction-safe Data update
            ...
            return  global.sails.model.data.update({id: data.id},
        ...
        .then(function(res) {
            let idData = res.id;
            console.log("WaterlineStrategy.updateData: transaction committed updating Data with ID: " + idData);
            return idData;
        })
        .catch(function(error){
     ...
     */
    deleteData(id) {
        return global.sails.model.data.destroy({id : id })
        .then(function(res) {
            return res;
        })
        .catch(function(error) {
    ...
    createSample(sample, sampleTypeName) {
        ...
        // transaction-safe sample creation
            ...
            // store the new Sample entity
                ...
                return global.sails.model.sample.create({
    ...
    updateSample(sample) {
            ...
            return global.sails.model.sample.update({ id: sample.id },{
                biobank: sample.biobank,
                parent_subject: sample.donor,
                metadata: sample.metadata,
                updated_at: new Date()
     ...
     */
    deleteSample(id) {
        return global.sails.model.sample.destroy({id : id })
        .then(function(res) {
            return res;
        })
        .catch(function(error) {
        ...
        let idSubject = null;
            ...
            return BluebirdPromise.try(function() {
                if (!subject.personalInfo) {
                    ...
                    return global.sails.model.personaldetails.create({
            ...
            .then(function(result) {
                subject.personalInfo = result.id;
                ...
                return global.sails.model.subject.create({
         ...
         // Knex supports implicit commit/rollback
        .then(function(inserts) {
            console.log("WaterlineStrategy.createSubject: transaction committed for new Subject: " + idSubject);
            return idSubject;
        })
        .catch(function(error) {
            console.log("WaterlineStrategy.createSample - error caught");
        ...
        delete subject.projects;
            ...
            return BluebirdPromise.try(function() {
                ...
                // otherwise update personal_details
                    ...
                    return global.sails.model.personaldetails.update({ id : subject.personalInfo.id,},{
                        surname: subject.personalInfo.surname,
                        given_name: subject.personalInfo.givenName,
                        birth_date: subject.personalInfo.birthDate
                    });
            ...
            .then(function(id) {
                console.log("WaterlineStrategy.updateSubject - updating Subject...");

                if(id & id[0]) {
                    subject.personalInfo = id[0];
                }
                return global.sails.model.subject.update({ id : subject.id,},{
                    tags: JSON.stringify(subject.tags),
                    notes: subject.notes,
                    metadata: subject.metadata,
                    updated_at: new Date(),
    ...
    deleteSubject(id) {
        ...
        return global.sails.model.subject.update({ id : id})
        .then(function(res) {
            return res;
        })
        .catch(function(error) {
